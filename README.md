### Привет! Я - Лёша, frontend разработчик!

- 👀 Интересуюсь web-разработкой, кино и путешествиями
- 📫 Как связаться: aleksey.gaev07@gmail.com
...
- **Фронтенд**: JavaScript, React, Hooks API, Redux (Saga, Thunk), HTML5, CSS3
- **Бекенд**: Node.js, Express, Sessions, CORS, hbs
